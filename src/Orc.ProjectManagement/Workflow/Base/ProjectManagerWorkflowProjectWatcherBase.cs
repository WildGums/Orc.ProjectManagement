...
{
    private readonly Dictionary<string, Stack<IProjectManagerWorkflowItem>> _activationStacks = new();
    private readonly Dictionary<string, Stack<IProjectManagerWorkflowItem>> _closingStacks = new();
    private readonly Dictionary<string, Stack<IProjectManagerWorkflowItem>> _loadingStacks = new();
    private readonly Dictionary<string, Stack<IProjectManagerWorkflowItem>> _refreshingStacks = new();
    private readonly Dictionary<string, Stack<IProjectManagerWorkflowItem>> _savingStacks = new();
