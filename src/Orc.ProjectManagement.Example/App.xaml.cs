...
using Orc.ProjectManagement.Example.Views;
using Orc.Theming;
using Orchestra;
    ...
    public App()
    {
        var hostBuilder = new HostBuilder()
            .ConfigureServices((hostContext, services) =>
            {
                ...
                services.AddSingleton<IProjectReader, PersonProjectReader>();
                services.AddSingleton<IProjectWriter, PersonProjectWriter>();
                services.AddTransient<IProjectRefresher, FileProjectRefresher>();
